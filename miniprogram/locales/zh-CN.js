const zhCN = {
  ...
  'index.function.purchase': '用户中心',
  'index.function.teachers': '教练介绍',
  'index.function.shop': '周边商城',
  'index.teachers.section': '教练 TUTOR',
  ...
  'teacher.courses': '课程',
  'teacher.sessions': '节',
  'teacher.no.info': '暂无教练信息',
  'teacher.no.more': '没有更多教练了',
  'teacher.load.more': '加载更多',
  'teacher.introduction': '教练介绍',
